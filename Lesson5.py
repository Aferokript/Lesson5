...
for i in range(10):
    ...
    print("Выбранные навыки:", skills)
    print("Стилизованные навыки:", styled_skills)
    ...
    svg_content = file_operations.render_template('charsheet.svg', 'charsheet-0.svg', context)
    card = open('charsheet.svg', 'w')
